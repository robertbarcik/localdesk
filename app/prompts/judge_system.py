...
1. **Grounding:** Is the response grounded in the retrieved context? The assistant should not invent procedures, policies, or technical steps that aren't in the retrieved documents. Minor phrasing differences are acceptable; fabricated information is not.
...
Be pragmatic. Not every response will have retrieved context (e.g., greetings, clarifying questions). Judge these on tone and appropriateness only. Only BLOCK responses with clear, serious problems."""
